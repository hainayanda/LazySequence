...
public extension LazySequence {
    ...
    /// - Complexity: Executing this code will have complexity of O(1). Iterating it will have complexity O (*n*) at if iteration count is less than given maximum iteration and O (*m*) if iteration count is more than given maximum iteration, where *n* is the original sequence iterator iteration count, and *m* is given maximum iteration count
    ...
    /// - Complexity: Executing this code will have complexity of O(1). Iterating it will have complexity O (*n*) at maximum and O (*m*) at minimum, where *n* is the original sequence iterator iteration count, and *m* is iteration count until condition is met
